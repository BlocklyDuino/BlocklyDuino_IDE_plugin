 ...
 */
public class BlocklyDuinoPlugin implements Tool {
    ...
    public static void main(String[] args) {
        BlocklyDuinoPlugin.startApplication();               
    ...
    public static void startApplication(){
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                BlocklyDuinoPlugin plugin = new BlocklyDuinoPlugin();
                try {
    ...
    public void run() {
        try{
            BlocklyDuinoPlugin.editor.toFront();
    ...
    public void init(Editor editor) {
        BlocklyDuinoPlugin.editor = editor;        
    }
}