 ...
 */
public class BlocklyDuinoServer {
    ...
    public BlocklyDuinoServer(Editor editor, Window ownerWindow){
        this.editor = editor;
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                try{
                    ...
                    //System.out.println("get BlocklyDuinoPlugin class");
                    Class ed = BlocklyDuinoPlugin.editor.getClass();
                    ...
                    BlocklyDuinoPlugin.editor.getCurrentTab().setText(code);
                ...
                BlocklyDuinoPlugin.editor.handleExport(false);
    ...
    public void saveCode(String code) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                //System.out.println("handleExport");
                BlocklyDuinoPlugin.editor.handleSaveAs();
                //System.out.println("Done handling export");
            }
        });
    }
    ...
    public String IDEloadXML() {
        ...
        if (selectedFile != null) {
            ...
            try {
                ...
                Logger.getLogger(BlocklyDuinoServer.class.getName()).log(Level.SEVERE, null, ex);
