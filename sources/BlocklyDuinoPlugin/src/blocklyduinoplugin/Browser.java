...
class Browser extends Region {
    ...
    public BlocklyDuinoServer serverObject;
    ...
    public Browser(Editor editor) {
        ...
        changeListener = new ChangeListener<State>() {
                ...
                public void changed(ObservableValue<? extends State> ov,
                    ...
                    if (newState == State.SUCCEEDED) {
                        ...
                        serverObject = new BlocklyDuinoServer(editor, Browser.this.getScene().getWindow());
                            JSObject win = (JSObject) webEngine.executeScript("window");
                            win.setMember("BlocklyDuinoServer", serverObject);
                        }else{
                    }
                    }
                };
        ...
        baseurl = baseurl.replace("BlocklyDuinoPlugin.jar", "");
        
        webEngine.load(baseurl + "BlocklyDuino/apps/blocklyduino/index_IDE.html");
